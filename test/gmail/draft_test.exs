...
defmodule Gmail.DraftTest do
  ...
  setup do
    ...
    draft = %{
      ...
      "message" => %{"id" => "14c9d65152e73310", "threadId" => "14c99e3025c516a0"}
    }
    ...
    drafts = %{
      "drafts" => [
        ...
        %{
          ...
          "message" => %{"id" => "14b6a70ff09cdd3b", "threadId" => "14b643d16976ad29"}
        },
        %{
          "id" => "1478425285387648346",
          "message" => %{"id" => "14846bf6ca7c7d5a", "threadId" => "14844b4410da5151"}
        }
      ]
    }
